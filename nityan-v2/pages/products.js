...
const products = [
  ...
  { name:'Garlic Powder',                  cat:'Spice Powders', img:'/product11.png', short:'Pungent, pure garlic powder with consistent quality.',                            desc:'Produced from premium Indian garlic varieties, carefully dehydrated and milled to retain aroma and potency.' },
  ...
  { name:'Vermicompost',                   cat:'Organic',       img:'/product12.png', short:'Nutrient-rich organic compost from controlled vermiculture.',                     desc:'High-quality vermicompost from managed earthworm composting. Rich in NPK, micronutrients, and beneficial microbes — ideal for horticulture.' },
  ...
  { name:'Handicrafts',                    cat:'Craftsmanship', img:'/product15.png', short:'Authentic Indian artisanal products for global retail.',                          desc:'Curated collection of handmade Indian handicrafts — textiles, wood carvings, brassware, and decorative items crafted by skilled artisans across India.' },
