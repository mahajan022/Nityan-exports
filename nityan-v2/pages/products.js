...
const products = [
  ...
  { name:'Dehydrated Onion Powder',        cat:'Spice Powders', img:'/product.png', short:'Hygienically processed and vacuum-packed for long shelf life.',                   desc:'Premium dehydrated onion powder processed in hygienic facilities, with consistent granule size and flavour profile meeting international food standards.' },
  { name:'Ginger Powder',                  cat:'Spice Powders', img:'/product.png', short:'Aromatic, potent ginger powder from Indian farms.',                               desc:'Sun-dried and ground Indian ginger, renowned for its high gingerol content. Ideal for food processing, beverages, and pharmaceutical industries.' },
  { name:'Amla (Indian Gooseberry) Powder',cat:'Spice Powders', img:'/product.png', short:'Vitamin C-rich superfood powder exported globally.',                              desc:'Spray-dried and cold-processed Amla powder retaining maximum nutritional value. Widely used in Ayurvedic supplements, nutraceuticals, and food products.' },
  { name:'Banana Powder',                  cat:'Spice Powders', img:'/product.png', short:'Naturally sweet banana powder for food and health industries.',                   desc:'Made from ripe Indian bananas, our banana powder is used in infant foods, health drinks, bakery products, and ice creams globally.' },
  { name:'Garlic Powder',                  cat:'Spice Powders', img:'/product.png', short:'Pungent, pure garlic powder with consistent quality.',                            desc:'Produced from premium Indian garlic varieties, carefully dehydrated and milled to retain aroma and potency.' },
  ...
  { name:'Vermicompost',                   cat:'Organic',       img:'/product.png', short:'Nutrient-rich organic compost from controlled vermiculture.',                     desc:'High-quality vermicompost from managed earthworm composting. Rich in NPK, micronutrients, and beneficial microbes — ideal for horticulture.' },
  ...
  { name:'Handicrafts',                    cat:'Craftsmanship', img:'/product.png', short:'Authentic Indian artisanal products for global retail.',                          desc:'Curated collection of handmade Indian handicrafts — textiles, wood carvings, brassware, and decorative items crafted by skilled artisans across India.' },
